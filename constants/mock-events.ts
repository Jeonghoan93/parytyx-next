...
export const events = [
  ...
  },
  {
    ...
    address: {
      country: "Sweden",
      street: "22 Stadsgårdshamnen, Södermalm",
      postalCode: "116 45",
      state: "Stockholm",
      city: "Stockholm",
    },
    title: "90s Silent Disco at Fotografiska, Stockholm (Sweden)",
    minGuests: 10,
    maxGuests: 100,
    desc: "An experience like no other is coming to Swedens most incredible places!",
